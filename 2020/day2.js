const passwords = [[6, 9, 'z', 'qzzzzxzzfzzzz'],
[2, 4, 's', 'xgmsdts'],
[6, 7, 'k', 'khqpsvk'],
[1, 3, 'k', 'knkqh'],
[4, 11, 'z', 'lwnzgzlmpvz'],
...
function validatePassword(info) {
	const loc1 = info[0] - 1,
		...
		letter = info[2],
		text = info[3];
	return (text[loc1] === letter & text[loc2] !== letter) || (text[loc2] === letter & text[loc1] !== letter);
}
